#ifndef CALIBRATIONRESETSCREEN_H
#define CALIBRATIONRESETSCREEN_H
...
public:
    CalibrationResetScreen(TFT_eSPI* tft, TouchManager* touchMgr, SettingsManager* settingsMgr);
...
#endif // CALIBRATIONRESETSCREEN_H
